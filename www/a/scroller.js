function ScrollView(element, options) {
    ...
    function tick() {
        ...
        if (typeof velocity === 'number' && Math.abs(velocity) > MIN_VELOCITY && !isDown) {
            ...
            velocity = 0;
            scrollView.shift(wrapperPosition % 1, false);
        }
    }
    ...
    scrollView.shift = function (delta, forced) {
        var value;
    ...
    scrollView.getPosition = function () {
